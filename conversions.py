def initial():
    ...
    if initial_unit == "stones" and final_unit == "kg":
        print(from_stones_to_kg(int(str(input("Enter the amount")))))
    elif initial_unit == "pounds" and final_unit == "kg":
        print(from_pounds_to_kg(int(str(input("Enter the amount")))))
    elif initial_unit == "kg" and final_unit == "stones":
        print(from_kg_to_stones(int(str(input("Enter the amount")))))
    elif initial_unit == "kg" and final_unit == "pounds":
        print(from_kg_to_pounds(int(str(input("Enter the amount")))))
    else:
        False
